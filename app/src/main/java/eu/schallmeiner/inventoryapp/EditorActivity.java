...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(mCurrentInventoryUri == null){
            setTitle(getString(R.string.add_product_label));
    ...
    private void saveInventory() {
        ...
        values.put(InventoryContract.InventoryEntry.COLUMN_INV_PRODUCT_NAME, nameString);
        values.put(InventoryContract.InventoryEntry.COLUMN_INV_SUPPLIER_NAME, supplierNameString);
        values.put(InventoryContract.InventoryEntry.COLUMN_INV_SUPPLIER_PHONE_NUMBER, supplierPhoneNumberString);

        double price = 0.0;
        if (!TextUtils.isEmpty(priceString)) {
            price = Double.parseDouble(priceString);
        }
        values.put(InventoryContract.InventoryEntry.COLUMN_INV_PRICE, price);

        int quantity = 0;
        if (!TextUtils.isEmpty(quantityString)) {
            quantity = Integer.parseInt(quantityString);
        }
        values.put(InventoryContract.InventoryEntry.COLUMN_INV_QUANTITY, price);
        ...
        if (mCurrentInventoryUri == null) {
            ...
            if (newUri == null) {
                ...
                Toast.makeText(this, getString(R.string.succeeded),
                        Toast.LENGTH_LONG).show();
            }
        } else {
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int supplierNameColumnIndex = cursor.getColumnIndex(InventoryContract.InventoryEntry.COLUMN_INV_SUPPLIER_NAME);
            int supplierPhoneNumberColumnIndex = cursor.getColumnIndex(InventoryContract.InventoryEntry.COLUMN_INV_SUPPLIER_PHONE_NUMBER);
    ...
    private void showUnsavedChangesDialog(
        ...
        builder.setNegativeButton(R.string.continue_unsaved, new DialogInterface.OnClickListener() {
